...
var ASSETS = Object.freeze({
  pilotOutput:
      'projects/REPLACE_WITH_PROJECT_ID/assets/stickleback_validation/' +
      'REPLACE_WITH_RUN_VERSION/pilot_output_YYYY_MM_DD_v1',
  osmMatches:
      'projects/REPLACE_WITH_PROJECT_ID/assets/stickleback_validation/' +
      'REPLACE_WITH_OSM_SNAPSHOT_VERSION/osm_matches_YYYY_MM_DD_v1',
  copernicusWindows:
      'projects/REPLACE_WITH_PROJECT_ID/assets/stickleback_validation/' +
      'REPLACE_WITH_RUN_VERSION/copernicus_windows_YYYY_MM_DD_v1'
});
